              ...
              <div className="grid md:grid-cols-3 gap-8 items-center">
                <div className="md:col-span-1 flex justify-center">
                  <div className="relative">
                    ...
                    <div className="relative w-48 h-48 bg-gradient-to-br from-slate-800 to-slate-700 rounded-full border-4 border-amber-500/40 flex items-center justify-center">
                      <span className="text-6xl text-amber-400/50">HA</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-6 text-center md:text-left">
                  ...
                  <div className="space-y-3 py-4">
                    <div className="flex items-center gap-3 text-amber-100/70">
                      ...
                      <span><strong className="text-amber-200">Format:</strong> Innbundet / Pocket</span>
                    </div>
                    <div className="flex items-center gap-3 text-amber-100/70">
                      <div className="w-2 h-2 bg-amber-500 rounded-full" />
                      <span><strong className="text-amber-200">Pris:</strong> 299,- kr</span>
                    </div>
                    <div className="flex items-center gap-3 text-amber-100/70">
                      <div className="w-2 h-2 bg-amber-500 rounded-full" />
